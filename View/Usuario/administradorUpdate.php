...
<div class="container mt-1">
   ...
   <?php
    ...
    ?>
        <form id="administradorUpdate" action="<?php echo getUrl('Usuario', 'Administrador', 'postUpdateAdministrador', false, 'ajax'); ?>" method="post" enctype="multipart/form-data">
            <div class="row g-3">
                <div class="col-md-3">
...
<script src="../web/assets/js/usuario/administradorUpdate.js"></script>