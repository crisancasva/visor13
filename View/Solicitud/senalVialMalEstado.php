<div class="container mt-1">
    <h3 class="display-4 text-center mt-0 mb-5" style="font-family: 'Poppins', sans-serif;" >Solicitud de señal vial en mal estado</h3>
    <p> Los campos marcados con un asterisco (<span class="text-danger">*</span>) son obligatorios.</p>
   
    <form id="solicitud" action="<?php echo getUrl('Solicitud', 'SenalVialMalEstado', 'postSenalVialMalEstado', false, 'ajax'); ?>" method="post" enctype="multipart/form-data">
        <div class="row g-3">
            <div class= "col-md-4">
                <label>Orientacion<span class="text-danger">*</span></label>
                <select name="orientcod" id= "orientacion" class = "form-control" data-url="<?php echo getUrl("Solicitud","SenalVialMalEstado","getSenal",false,"ajax")?>" required>
                    <option value="">Seleccione...</option>
                    <?php
                    foreach($orientacion as $ori){
                        echo "<option value = '".$ori['orientcod']."'>".$ori['orientdescripcion']."</option>";
                    }
                    ?>
                </select>
            </div>
            <div class= "col-md-4">
                <label>Señal de transito<span class="text-danger">*</span></label>
                <select name="sencod" id="senal" class = "form-control" data-url="<?php echo getUrl("Solicitud","SenalVialMalEstado","getCategoria",false,"ajax")?>" required>
                    <option value="">Seleccione...</option>      
                </select>
            </div>
            <div class= "col-md-4">
                <label>Categoria de la señal<span class="text-danger">*</span></label>
                <select name="csencod" id="catesenal" class = "form-control" data-url="<?php echo getUrl("Solicitud","SenalVialMalEstado","getCategoria",false,"ajax")?>"  disabled>
                </select>
            </div>

            <div class= "col-md-4">
                <label>Tipo de daño<span class="text-danger">*</span></label>
                <select name="tdanocod" class = "form-control"  data-url="<?php echo getUrl("Solicitud","SenalVialMalEstado","getTipoDano")?>" required>
                    <option value="">Seleccione...</option>
                    <?php
            ...
            <div class="col-md-4">
                ...
                <textarea type="text" name="smeDescripcion" class="form-control" rows="1" placeholder= "Escribe una descripción detallada" required></textarea>
            </div>
            <div class="col-md-4">
                <label>Subir imagen<span class="text-danger">*</span></label>
                <input type="file" name="smeImagen" class="form-control" accept=".jpg, .jpeg, .png" required>
            </div>
            
            <p>Ingrese la dirección de la señal a reparar.</p>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name = "smeDireccion" id="direccionCompleta" class="form-control" placeholder="La dirección se completará aquí" readonly>
            </div>   
            ...
            <p><b>Indica en el mapa el punto de la señalización vial en mal estado.</b></p>
...
<script src="../web/assets/js/solicitud/SenalVialMalEstado.js"></script>
