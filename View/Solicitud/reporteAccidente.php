<div class="container mt-1">
    <h3 class="display-4 text-center mt-0 mb-5" style="font-family: 'Poppins', sans-serif;">Reporte Accidente de Transito</h3>
    ...
    <form id="reporteAccidente" action="<?php echo getUrl('Solicitud', 'ReporteAccidente', 'postReporteAccidente', false, 'ajax'); ?>" method="post" enctype="multipart/form-data">
        <div class="row g-3">
            <div class= "col-md-4">
                    ...
                    <input type="number" name="numvehiculo" id="numvehiculo" class="form-control" data-url="<?php echo getUrl("Solicitud","ReporteAccidente","vehiSeleccionados",false,"ajax")?>" required placeholder="Cantidad de vehículos" >
                    <div class= "row-md-4" id="vehiseleccionado" > 
            ...
            <div class= "col-md-4">
                ...
                <select name="tiposiniestro" id="tiposiniestro" class = "form-control" data-url="<?php echo getUrl('Solicitud', 'ReporteAccidente', 'blocOtroTipo', false, 'ajax'); ?>" required>
                    <option value="">Seleccione...</option>  
                    <?php
                        foreach($accidente as $acci){
                            echo "<option value='".$acci['tsinicod']."'>".$acci['tsinidescripcion']."</option>";
                        }
                    ?>
                </select>
                <div class="mt-4 row-md-4" id="otrotipo" >
            ...
            <div class= "col-md-4">
                ...
                <input type="number" name="lesionados" id="lesionados" class="form-control" min="0">
                <p style="margin-left: 10px;"><b>Si no hay lesionados,ingresar cero (0).</b></p> 
          
            </div>
            <div class="col-md-4">
                <label>Observacion<span class="text-danger">*</span></label>
                <textarea type="text" name="raObservacion" class="form-control" placeholder= "Escribe una descripción detallada" required></textarea>
            </div>
            <div class="col-md-4">
                <label>Subir imagen<span class="text-danger">*</span></label>
                <input type="file" name="raImagen" class="form-control" accept=".jpg, .jpeg, .png" required>
            </div>
            <p>Ingrese la dirección donde ocurrio el accidente.</p>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name = "raDireccion" id="direccionCompleta" class="form-control" placeholder="La dirección se completará aquí" readonly>
            </div>   
            <div class="col-md-4">
            ...
            <div>
                <div style="position: relative; right: -660px; top: 147%; transform: translateY(-620px); display: flex; align-items: center; gap: 10px; font-family: Arial, sans-serif;">
            ...
            <div>
                <div style="position: relative; right: -660px; top: 154%; transform: translateY(-620px); display: flex; align-items: center; gap: 10px; font-family: Arial, sans-serif;">
            ...
            <div>
                <div style="position: relative; right: -660px; top: 161%; transform: translateY(-620px); display: flex; align-items: center; gap: 10px; font-family: Arial, sans-serif;">
            ...
            <div>
                <div style="position: relative; right: -660px; top: 168%; transform: translateY(-620px); display: flex; align-items: center; gap: 10px; font-family: Arial, sans-serif;">
            ...
            <div>
                <div style="position: relative; right: -660px; top: 175%; transform: translateY(-620px); display: flex; align-items: center; gap: 10px; font-family: Arial, sans-serif;">
            ...
            <div>
                <div style="position: relative; right: -660px; top: 182%; transform: translateY(-620px); display: flex; align-items: center; gap: 10px; font-family: Arial, sans-serif;">
...
<script src="../web/assets/js/solicitud/ReporteAccidente.js"></script>
