<div class="container mt-1">
    <h3 class="display-4 text-center mt-0 mb-5" style="font-family: 'Poppins', sans-serif;">Solicitud reductor de velocidad en mal estado</h3>
    <p> Los campos marcados con un asterisco (<span class="text-danger">*</span>) son obligatorios.</p>
   
    <form id="solicitudReductor" action="<?php echo getUrl('Solicitud', 'ReductorMalEstado', 'postReductorMalEstado', false, 'ajax'); ?>" method="post" enctype="multipart/form-data">
        <div class="row g-3">
            <div class= "col-md-4">
                <label>Tipo de reductor<span class="text-danger">*</span></label>
                <select name="reducod" id="redu" class = "form-control" data-url="<?php echo getUrl("Solicitud","ReductorMalEstado","getCategoriaReductor",false,"ajax")?>" required>
            ...
            <div class= "col-md-4">
                <label>Categoría del reductor<span class="text-danger">*</span></label>
                <select name="crcod" id="catereductor" class = "form-control" data-url="<?php echo getUrl("Solicitud","ReductorMalEstado","getCategoriaReductor",false,"ajax")?>" required  disabled>
                </select>
            </div>
            <div class= "col-md-4">
            ...
            <div class="col-md-4">
                ...
                <textarea type="text" name="rmedescripcion" class="form-control" rows="1" placeholder= "Escribe una descripción detallada" required></textarea>
            </div>
            <div class="col-md-4">
                <label>Subir imagen<span class="text-danger">*</span></label>
                <input type="file" name="rmeimagen" class="form-control" accept=".jpg, .jpeg, .png" required>
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name ="rmedireccion" id="direccionCompleta" class="form-control" placeholder="La dirección se completará aquí" readonly>
            </div> 
            ...
            <p><b>Indica en el mapa el punto del reductor de velocidad en mal estado.</b></p>
...
<script src="../web/assets/js/solicitud/reductorMalEstado.js"></script>