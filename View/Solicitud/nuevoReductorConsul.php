<div class="container-fluid mt-2">
    ...
    ?>
    <h2 class="text-center display-4" style="margin-top: 5px; margin-bottom: 15px;">Solicitudes de nuevos reductores de velocidad</h2>
    <?php
        }else{
    ?>
    <h2 class="text-center display-4" style="margin-top: 5px; margin-bottom: 15px;">Mis solicitudes de nuevos reductores de velocidad</h2>
    <?php
        }
    ?>
    ...
    <table id = "tablaConsultar" class="table table-striped table-hover">
        <thead style="position: sticky; top: 0; background: #fff; z-index: 100;">
            ...
            <tbody>
                <?php
                    foreach($nuevoredu as $redu){
                        echo "<tr>";
                        if($_SESSION['rolcod']===2 ||$_SESSION['rolcod']===1){
                            echo "<td>". $redu['nrcod']."</td>";
                        }
                        echo "<td>". $redu['nrdescripcion']."</td>";
                        echo "<td><img src='". $redu['nrimagen']."'width='60px'></td>";
                        echo "<td>". $redu['nrdireccion']."</td>";
                        echo "<td>". $redu['nrobservacion']."</td>";
                        echo "<td>". $redu['nrfecha']."</td>";
                        ...
                        if($_SESSION['rolcod']===2 ||$_SESSION['rolcod']===1){
                            echo "<td><button class='btn' style='background:#4E74A6 !important; color:white;' onclick=\"window.location.href='" . getUrl('Solicitud', 'NuevoReductor', 'getNuevoReductorUpdate', array('nrcod' => $redu['nrcod'])) . "'\">Editar</button></td>";
                        }
                        echo "</tr>";
                    }
                ?>
...
<script src="../web/assets/js/solicitud/nuevoReductorConsul.js"></script>