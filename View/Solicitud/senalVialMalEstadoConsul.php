<div class="container-fluid mt-2">
    ...
    ?>
    <h2 class="text-center display-4" style="margin-top: 5px; margin-bottom: 15px;">Solicitudes de señalizaciones en mal estado</h2>
    <?php
        }else{
    ?>
    <h2 class="text-center display-4" style="margin-top: 5px; margin-bottom: 15px;">Mis solicitudes de señalizaciones en mal estado</h2>
    <?php
        }
    ?>
        ...
        <table id = "tablaConsultar" class="table table-striped table-hover">
            <thead style="position: sticky; top: 0; background: #fff; z-index: 100;">
                ...
                <tbody>
                    ...
                    <?php
                        foreach($senalMal as $sena){
                            echo "<tr>";
                            if($_SESSION['rolcod']===2 || $_SESSION['rolcod']===1){
                                echo "<td>". $sena['smecod']."</td>";
                            }
                            echo "<td>". $sena['smedescripcion']."</td>";
                            echo "<td><img src='". $sena['smeimagen']."'width='60px'></td>";
                            echo "<td>". $sena['smedireccion']."</td>";
                            echo "<td>". $sena['smefecha']."</td>";
                            echo "<td>". $sena['smeobservacion']."</td>";
                            if($_SESSION['rolcod']===2 || $_SESSION['rolcod']===1){
                                echo "<td>". $sena['usunombrecompleto']."</td>";
                            }
                            echo "<td>". $sena['estdescripcion']."</td>";
                            echo "<td>". $sena['sendescripcion']."</td>";
                            echo "<td>". $sena['orientdescripcion']."</td>";
                            echo "<td>". $sena['tdanodescripcion']."</td>";
                            if($_SESSION['rolcod']===2 || $_SESSION['rolcod']===1){
                                echo "<td><button class='btn' style='background:#4E74A6 !important; color:white;' onclick=\"window.location.href='" . getUrl('Solicitud', 'SenalVialMalEstado', 'getSenalMalEstadoUpdate', array('smecod' => $sena['smecod'])) . "'\">Editar</button></td>";
                            }
                            echo "</tr>";
                        }
                    ?>
...
<script src="../web/assets/js/solicitud/senalVialMalEstadoConsul.js"></script>