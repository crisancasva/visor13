<div class="container mt-1">
    <h3 class="display-4 text-center mt-0 mb-5" style="font-family: 'Poppins', sans-serif;">Solicitud de nueva señal</h3>
    <p> Los campos marcados con un asterisco (<span class="text-danger">*</span>) son obligatorios.</p>
   
    <form id="solicitudNuevaSenal" action="<?php echo getUrl('Solicitud', 'NuevaSenal', 'postNuevaSenal', false, 'ajax'); ?>" method="post" enctype="multipart/form-data">
        <div class="row g-3">
            <div class= "col-md-4">
                <label>Orientacion<span class="text-danger">*</span></label>
                <select name="orientcod" id= "orientacion" class = "form-control" data-url="<?php echo getUrl("Solicitud","NuevaSenal","getSenal",false,"ajax")?>" required>
            ...
            <div class= "col-md-4">
                ...
                <select name="sencod" id="senal" class = "form-control" data-url="<?php echo getUrl("Solicitud","NuevaSenal","getCategoria",false,"ajax")?>" required>
                    <option value="">Seleccione...</option>      
                </select>
            </div>
            <div class= "col-md-4">
                <label>Categoria de la señal<span class="text-danger">*</span></label>
                <select name="csencod" id="catesenal" class = "form-control" data-url="<?php echo getUrl("Solicitud","NuevaSenal","getCategoria",false,"ajax")?>"  disabled>
                </select>
            </div>

            <div class="col-md-4">
                <label>Descripción<span class="text-danger">*</span></label>
                <textarea type="text" name="nsdescripcion" class="form-control" rows="1" placeholder= "Escribe una descripción detallada" required></textarea>
            </div>
            <div class="col-md-4">
                <label>Subir imagen<span class="text-danger">*</span></label>
                <input type="file" name="nsimagen" class="form-control" accept=".jpg, .jpeg, .png" required>
            </div>
            
            <p>Ingrese la dirección donde se ubicara la nueva señal.</p>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name = "nsdireccion" id="direccionCompleta" class="form-control" placeholder="La dirección se completará aquí" readonly>
            </div>   
            ...
            <p><b>Indica en el mapa el punto de la nueva señalización vial.</b></p>
...
<script src="../web/assets/js/solicitud/nuevaSenal.js"></script>
