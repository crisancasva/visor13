...
var pixel_img = new Image(); pixel_img.src = '../web/assets/js/visor/misc/img/pixel.gif';
...
//  var _Xclick; var _Yclick;
  ...
  var _iconLoading = '../web/assets/js/visor/misc/img/cargando.gif';
...
function pointOverlay( p_icon, p_infoSkin, p_title, p_x, p_y, p_item_name, p_item_value )
{
  ...
  {
    // Create a default Info-window icon object...
    _infoSkin = new msInfoSkin( 'web/assets/js/visor/misc/img/angolo_a.png', 'web/assets/js/visor/misc/img/angolo_b.png',
                                'web/assets/js/visor/misc/img/angolo_c.png', 'web/assets/js/visor/misc/img/angolo_d.png',
                                'web/assets/js/visor/misc/img/report_t.png', 'web/assets/js/visor/misc/img/report_d.png',
                                'web/assets/js/visor/misc/img/report_l.png', 'web/assets/js/visor/misc/img/report_r.png',
                                'web/assets/js/visor/misc/img/report_x.png', 'web/assets/js/visor/misc/img/close.png',
                                'web/assets/js/visor/misc/img/report_arrow.png' );
  }
...
function msIcon( p_img, p_shd, p_offsetX, p_offsetY )
{
  ...
  if ( _img_name == null )
  {
    _img_name = 'web/assets/js/visor/misc/img/mm_20_red.png';
    _shd_name = 'web/assets/js/visor/misc/img/mm_20_shadow.png';
    _offsetX  = 6; _offsetY = 19;
  }
  if (_img_name == '') {_img_name='web/assets/js/visor/misc/img/pixel.gif';}
  if (_shd_name == '') {_shd_name='web/assets/js/visor/misc/img/pixel.gif';}
...
function msToolbar(p_msMap, _control, _default)
{
  ...
  var _iconFullExtentButton = '../web/assets/js/visor/misc/img/mundo.png';
  var _iconZoomboxButton    = '../web/assets/js/visor/misc/img/lupa.png';
  var _iconPanButton        = '../web/assets/js/visor/misc/img/mano.png';
  var _iconZoominButton     = '../web/assets/js/visor/misc/img/lupamas.png';
  var _iconZoomoutButton    = '../web/assets/js/visor/misc/img/lupamenos.png';
